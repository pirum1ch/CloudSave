...
public class MinioFileService {
    ...
    public File upload(String fileName, MultipartFile file)
    ...
    public void deleteFile(String filename) throws ExpiredJwtException, IOException,
            ...
            InternalException
    {
        log.log(Level.INFO, "Проверяем что входящие аргументы не пусты: " + filename);
        if (filename.isEmpty()) {
        ...
        if (fileRepo.findByName(filename) == null ) {
            log.log(Level.INFO, "Файла "+ filename +" не существует! ");
